...
//    set up layout frames and margins
    ...
    CGFloat inset = 20;
    CGFloat tempretureHeight = 110;
    CGFloat hiloHeight = 40;
    CGFloat iconHeight = 30;
    
    CGRect hiloFrame = CGRectMake(inset, headerFrame.size.height - hiloHeight, headerFrame.size.width - (2*inset), hiloHeight);
    CGRect tempretureFrame = CGRectMake(inset, headerFrame.size.height - (tempretureHeight + hiloHeight), headerFrame.size.width - (2*inset), tempretureHeight);
    CGRect iconFrame = CGRectMake(inset,
                                  tempretureFrame.origin.y - iconHeight,
    ...
    UILabel* tempretureLabel = [[UILabel alloc] initWithFrame:tempretureFrame];
    tempretureLabel.backgroundColor = [UIColor clearColor];
    tempretureLabel.textColor = [UIColor whiteColor];
    tempretureLabel.text = @"0°";
    tempretureLabel.font = [UIFont fontWithName:@"HelveticaNeue-UltraLight" size:120];
    [header addSubview:tempretureLabel];
    ...
    [[RACObserve([WXManager sharedManager], currentCondition) deliverOn:RACScheduler.mainThreadScheduler]
     subscribeNext:^(WXCondition *newCondition){
         tempretureLabel.text = [NSString stringWithFormat:@"%.0f°", newCondition.temperature.floatValue];
